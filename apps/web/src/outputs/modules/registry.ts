...
import {
  computeBirthweightParadoxOutput, computeCatsHighriseSyndromeOutput, computeChessSimpleFlipOutput,
  computeCollegeCompletedOutput, computeFrontDoorSmokingOutput, computeIcuCompletedOutput,
  computeInstrumentOutput, computeMBiasOutput, computeModeratorEffectOutput,
  computeObesityParadoxOutput, computePolicingEncountersOutput, computeSimpsonCompletedOutput,
  computeTutoringCompletedOutput, fallbackOutput, renderInstrumentOutput, renderModeratorEffectOutput
} from "./exampleHandlers";
import { computeStructuralDiagnosis, computeWhatIfAdvancedOutput } from "./compute";
import { renderCollegeOutput, renderHuhOutput, renderIcuOutput, renderSimpsonOutput, renderTutoringOutput, renderWhatIfAdvancedOutput } from "./components";
import type { CompletedOutputModule, CompletedOutputRenderOptions, OutputContext } from "../types";
import type {
  BasicOutputPunchline, BasicOutputPunchlineMetric, CollegeCompletedOutput, ComputedCompletedOutput,
  HuhCompletedOutput, HuhMetric, IcuCompletedOutput, InstrumentOutput, ModeratorEffectOutput,
  SimpsonCompletedOutput, TutoringCompletedOutput, WhatIfAdvancedOutput
} from "./types";
